...
export default async function Schedules({
  ...
  const packages = await packageService.findAll(search);

  return (
    <div className="">
      <div className="mx-auto flex min-h-screen w-full max-w-[90vw] flex-col gap-24 px-8 py-4 sm:py-32 md:max-w-screen-xl">
